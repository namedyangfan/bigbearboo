...
export const publish = (params) => { return axios.patch(`${API}/publish/${params.product_id}`, params)}

export const draft = (params) => { return axios.patch(`${API}/draft/${params.product_id}`, params)}
